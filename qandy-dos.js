...
// ── Server Storage ───────────────────────────────────────────────────────────
// Server storage functions have been moved to serverStorage.js.
// Message handlers below continue to call window.server* which are provided
// by serverStorage.js during gradual migration to the new API.

// (placeholder — keep this comment so the section marker is not lost)
