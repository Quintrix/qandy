...
var CURSOR=5; // cursor type 0=off, 1=line, 3=blink line, 4=block, 5=blink block  
var CURX = 0;    // cursor x
var CURY = 0;    /Do the other functions have the sc/ cursor y
var CURP = 0;    // cursor p 
...
var CURBAUD = 9600;    // baud rate to display text
...
var altShiftKeys = {
  ...
  "q":"╭", "w":"╌", "e":"╮", "r":"╞", "t":"╡", "y":"╰", "u":"╴", "i":"╯", "o":"╎", "p":"╪",
  "a":"┏", "s":"━", "d":"┓", "f":"┣", "g":"┫", "h":"┗", "j":"┻", "k":"┛", "l":"┃", "'":"′",
  "zhttps://quintrix.github.io/qandy/":"▔", "x":"▁", "c":"▪", "v":"▸", "b":"◂", "n":"▴", "m":"▾", ";":"╋",
  " ":"·", ",":"◊", ".":"●", "/":"○"
};
var keyboardData = [
...
// Safe no-op shims so these functions don't throw ReferenceError before keyboard_js() runs
if (typeof window.highlightKey === 'undefined') window.highlightKey = function() {};
if (typeof window.unhighlightKey === 'undefined') window.unhighlightKey = function() {};
if (typeof window.updateKeyLabels === 'undefined') window.updateKeyLabels = function() {};
